    ...
    <MainLayout>
      <TextBlock style={{
        ...
        <p>Настоящая политика обработки персональных данных составлена в соответствии с требованиями Федерального закона
          ...
          "Конструкция СПБ" (далее — Оператор).</p>
        ...
        <p>1.2. Настоящая политика Оператора в отношении обработки персональных данных (далее — Политика) применяется ко
          всей информации, которую Оператор может получить о посетителях веб-сайта <a
            href="https://constrspb.ru">https://constrspb.ru</a>.</p>
        ...
        <p>2.8. Персональные данные — любая информация, относящаяся прямо или косвенно к определенному или определяемому
          Пользователю веб-сайта <a href="https://constrspb.ru">https://constrspb.ru</a>.</p>
        <p>2.9. Персональные данные, разрешенные субъектом персональных данных для распространения, — персональные
          ...
          распространения).</p>
        <p>2.10. Пользователь — любой посетитель веб-сайта <a href="https://constrspb.ru">https://constrspb.ru</a>.</p>
        ...
        <p>5. Принципы обработки персональных данных
          ...
          допускается избыточность обрабатываемых персональных данных по отношению к заявленным целям их обработки.<br/>
        ...
        <p>6. Цели обработки персональных данных<br/>
          Цель обработки уточнение деталей заказа<br/>
        ...
        <p>
          ...
          href="mailto:info@constrspb.ru">info@constrspb.ru</a> с пометкой «Актуализация персональных данных».
        </p>
        <p>
        ...
        <p>
          ...
          href="mailto:info@constrspb.ru">info@constrspb.ru</a> с пометкой «Отзыв согласия на обработку персональных
          данных».
        </p>
        <p>
        ...
        <p>
          ...
          href="mailto:info@constrspb.ru">info@constrspb.ru</a>.
        </p>
        <p>
        ...
        <p>
          ...
          href="https://constrspb.ru">https://constrspb.ru</a>.
        </p>
      </TextBlock>
    </MainLayout>
  );
